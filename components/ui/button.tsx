  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary: "bg-gradient-to-r from-gradient-from via-gradient-via to-gradient-to text-white hover:shadow-lg hover:shadow-gradient-from/25 hover:scale-[1.02] active:scale-[0.98]",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "text-indigo-ocean bg-transparent hover:bg-indigo-ocean/10 hover:text-indigo-ocean",
        outline: "border border-indigo-ocean/20 bg-transparent text-indigo-ocean hover:bg-indigo-ocean/10",
